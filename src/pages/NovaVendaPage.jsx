    ...
    <div className="mx-auto max-w-3xl px-4 py-8 sm:px-6">
      ...
      {!carregandoDados && !erroCarregamento && (
        <form onSubmit={lidarComSubmit} className="mt-6 space-y-6">
          <div className="rounded-lg border border-slate-200 bg-white p-4 shadow-sm sm:p-6 space-y-4">
            <div>
              ...
              <select
                ...
                className="min-h-11 w-full rounded-lg border border-slate-300 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500"
              >
          ...
          <div className="rounded-lg border border-slate-200 bg-white p-4 shadow-sm sm:p-6">
            ...
            <button
              ...
              className="mt-4 flex min-h-11 items-center text-sm font-medium text-amber-600 transition-colors hover:text-amber-700"
            >
              + Adicionar item
            </button>
          ...
          <button
            type="submit"
            disabled={salvando}
            className="min-h-11 w-full sm:w-auto inline-flex items-center justify-center rounded-lg bg-amber-600 px-6 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-amber-700 disabled:opacity-60"
          >
